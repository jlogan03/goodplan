		...
		const state: ProjectState = {
			...
			contents: {
				"decisions.jsonl": {
					type: "jsonl",
					content: [
						{ id: "dec-1", status: "active", domain: "arch", title: "Use layers", summary: "4-layer architecture", date: "2026-03-20", supersededBy: null },
					],
				},
			},
		};
		...
		const state: ProjectState = {
			...
			contents: {
				"decisions.jsonl": {
					type: "jsonl",
					content: [
						{ id: "dec-2", status: "revisiting", domain: "testing", title: "Test strategy", summary: "Revisit vitest config", date: "2026-03-21", supersededBy: null },
					],
				},
			},
		};
		...
		const state: ProjectState = {
			...
			contents: {
				"decisions.jsonl": {
					type: "jsonl",
					content: [
						{ id: "dec-1", status: "active", domain: "arch", title: "Current", summary: "Active one", date: "2026-03-20", supersededBy: null },
						{ id: "dec-2", status: "superseded", domain: "arch", title: "Old", summary: "Replaced", date: "2026-03-19", supersededBy: "dec-1" },
					],
				},
			},
		};
