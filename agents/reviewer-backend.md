...
@${CLAUDE_PLUGIN_ROOT}/skills/_shared/references/review-backend.md
...
The `review` field contains your complete review text. The orchestrator will write it to `<tmpdir>/reviews/backend.md`.
