...
@${CLAUDE_PLUGIN_ROOT}/skills/_shared/references/review-api-contract.md
...
The `review` field contains your complete review text. The orchestrator will write it to `<tmpdir>/reviews/api-contract.md`.
