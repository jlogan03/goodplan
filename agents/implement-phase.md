...
- **Growing** subsystems: good tests, reasonable typing, pragmatic error handling
- **Exploratory** subsystems: working code with basic tests, acceptable shortcuts
