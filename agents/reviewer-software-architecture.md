...
@${CLAUDE_PLUGIN_ROOT}/skills/_shared/references/review-software-architecture.md
...
The `review` field contains your complete review text. The orchestrator will write it to `<tmpdir>/reviews/software-architecture.md`.
