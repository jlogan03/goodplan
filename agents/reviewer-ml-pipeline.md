...
@${CLAUDE_PLUGIN_ROOT}/skills/_shared/references/review-ml-pipeline.md
...
The `review` field contains your complete review text. The orchestrator will write it to `<tmpdir>/reviews/ml-pipeline.md`.
