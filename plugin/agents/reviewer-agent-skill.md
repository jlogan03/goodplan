...
@${CLAUDE_PLUGIN_ROOT}/agents/_references/review-agent-skill.md
...
The `review` field contains your complete review text. The orchestrator writes it to the round-based review directory (e.g., `<run-dir>/round-{N}/reviews/agent-skill.md`).
