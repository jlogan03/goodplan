...
- ROLLUP_LEARNINGS is a reducer-level operation (filter by `rollupTo` tag + batch append), exposed via RPC `begin('rollup', ...)`
...
| 02 | Decision & Learnings CLI | RPC wiring, 6 new commands (4 decision + 2 learning) |
