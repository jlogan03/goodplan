...
- [ ] End-to-end verification walkthrough in temp dir (steps 1-13 use `bun run src/index.ts`; step 14 uses compiled binary):
...
- [ ] Clean up any "deferred to slice 05" notes in architecture docs (rpc-layer-api.md, etc.)
