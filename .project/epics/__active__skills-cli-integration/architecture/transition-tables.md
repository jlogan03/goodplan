...
| plan-created | COMPLETE_REFINEMENT_ROUND | plan-refined | scores meet threshold (first round) | — | slice, status, round, scores, thresholdMet | Skip path: safe because plan-created guarantees plan.md exists (enforced by COMPLETE_PLAN guard) |
