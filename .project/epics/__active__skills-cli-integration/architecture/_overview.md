...
4. Semantic versioning with three-way compatibility checking (CLI ↔ project data ↔ skills)
...
- Goal storage in entity JSON (goals are fields within entity JSON, not separate markdown files)
