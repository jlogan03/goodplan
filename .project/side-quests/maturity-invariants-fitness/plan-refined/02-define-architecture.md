...
- [x] **Update graceful stop cases** in define-architecture SKILL.md: Add handling for interruption during Steps 8f/8g/8h. Insert between existing Step 8e cases and Step 9 cases in the graceful stop section. Use the existing `<!-- partial — interrupted during ... -->` marker pattern:
