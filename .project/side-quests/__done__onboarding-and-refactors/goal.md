...
> - `onboard-repo/` — onboarding existing repos into the workflow
> - `upgrade-workflow/` — migrating repos with old `.project/` to current version
> - `refactor-intelligence/` — upgrading complete-slice Step 9 with proactive refactor identification
>
