...
|---|---|---|---|---|---|---|---|
| Maturity table (`architecture/_overview.md`) | `/create-architecture` | `/create-plan`, `/create-slices`, `/complete` | — | `/refine-architecture` | `/complete`, `/audit-architecture` | `/audit-architecture` | SW Architecture reviewer |
