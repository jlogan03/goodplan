...
9. **Verification approach appropriateness**: Do the Expected Behavior items in this domain use the most direct verification method? (e.g., API phases should have curl/HTTP checks, not just unit tests)
```
...
12. **Verification approach appropriateness**: Do the Expected Behavior items in this domain use the most direct verification method? (e.g., UI phases should have browser-based verification, not just component render checks)
```
...
9. **Verification approach appropriateness**: Do the Expected Behavior items in this domain use the most direct verification method? (e.g., Database/migration phases should verify schema and data integrity with real queries, not just check migration ran)
```
...
8. **Verification approach appropriateness**: Do the Expected Behavior items in this domain use the most direct verification method? (e.g., Infrastructure phases should verify services are actually running and responding, not just check config files)
```
...
9. **Verification approach appropriateness**: Do the Expected Behavior items in this domain use the most direct verification method? (e.g., Job phases should trigger the actual job and verify side effects (DB state, files, logs), not just check the job is registered)
```
