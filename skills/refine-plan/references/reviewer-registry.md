...
| Software Architecture | Module boundaries, dependency direction, coupling/cohesion, layering, data flow, testability | `reviewers-cross-cutting.md` | `## Software Architecture Reviewer` |
...
| Reviewer | Focus | Prompt File | Section |
|---|---|---|---|
| UX & Information Architecture | Information architecture, task flow, visual hierarchy, accessibility, feedback, consistency, edge cases | `reviewers-cross-cutting.md` | `## UX & Information Architecture Reviewer` |
| TUI and CLI | Terminal UI layout, CLI argument design, input handling, output formatting, cross-platform compatibility | `reviewers-cross-cutting.md` | `## TUI and CLI Reviewer` |
| Repo, Tooling, & Docs | Project structure, build configuration, linting, hooks, dependency management, documentation | `reviewers-cross-cutting.md` | `## Repo, Tooling, & Docs Reviewer` |
| CI & GitHub Workflows | Workflow structure, triggers, action pinning, CI security, caching, artifacts, maintainability, testing | `reviewers-cross-cutting.md` | `## CI & GitHub Workflows Reviewer` |
| API Contract | Public interface design, backwards compatibility, versioning, documentation, contract testing | `reviewers-cross-cutting.md` | `## API Contract Reviewer` |
