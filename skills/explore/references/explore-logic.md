...
> See also: `~/.claude/skills/_shared/references/state-and-flow-formats.md` for state.md and flow-log.jsonl formats.
...
| Slice | `.project/vertical-slices/<name>/research/` | `.project/vertical-slices/<name>/brainstorm/` | N/A | `.project/vertical-slices/<name>/explore-complete.md` | `.project/vertical-slices/<name>/explore-skipped.md` |
...
## Prototype Mode (Project-Level Only)
...
3. `mkdir -p .project/prototypes/<name>/`
