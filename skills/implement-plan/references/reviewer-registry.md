...
| TUI and CLI | Terminal UI, CLI argument design, input handling, output formatting, cross-platform compatibility | `reviewers-cross-cutting.md` | `## TUI and CLI Reviewer` |
| Repo, Tooling, & Docs | Project structure, build config, linting, hooks, dependencies, documentation | `reviewers-cross-cutting.md` | `## Repo, Tooling, & Docs Reviewer` |
| CI & GitHub Workflows | Workflow structure, triggers, pinning, security, caching, artifacts, maintainability | `reviewers-cross-cutting.md` | `## CI & GitHub Workflows Reviewer` |
| API Contract | Public interfaces, backwards compatibility, versioning, contract testing | `reviewers-cross-cutting.md` | `## API Contract Reviewer` |
